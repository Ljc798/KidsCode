  ...
  return (
    <div className="rounded-2xl border border-black/5 bg-white/70 p-6 shadow-sm backdrop-blur dark:border-white/10 dark:bg-zinc-950/60">
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        ...
        <div className="rounded-2xl border border-dashed border-black/10 bg-white/40 p-5 text-sm text-zinc-600 dark:border-white/15 dark:bg-white/5 dark:text-zinc-300">
          More admin sections can go here.
        </div>
      </div>
    </div>
  )
